SRC = main.c run_command.c gnl/get_next_line.c gnl/get_next_line_utils.c signals.c\
	...
	lex/lexer.c lex/quote_validity.c lex/redirect_validity.c lex/split_by_qoute.c lex/split_by_redirect.c lex/split_by_space.c lex/pipe_lex.c lex/split_by_pipe.c\
