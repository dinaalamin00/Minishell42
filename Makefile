SRC = main.c run_command.c gnl/get_next_line.c gnl/get_next_line_utils.c signals.c\
	...
	lex/pipe_check.c lex/pipe_validity.c lex/split_by_pipe.c\
	execution/executor.c execution/duplicate_fds.c execution/here_doc.c execution/execute_command.c execution/execute_external.c\
